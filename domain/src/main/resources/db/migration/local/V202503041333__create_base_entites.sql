...
(
	...
	agency_id        bigint unique,
	fandom_id        bigint unique,
	name             varchar(255),
...
alter table public.v_tuber
	add constraint FK_v_tuber_TO_fandom
		foreign key (fandom_id) references public.fandom;